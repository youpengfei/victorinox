...
public class ClazzUtils {
    ...
    public static void main(String[] args) {
        final Set<Class<?>> classSet = getClasses("org.youyou.controller");
        for (Class<?> aClass : classSet) {
            ...
            for (Method method : methods) {
                ...
                if (isAction) {
                    System.out.println("\rmethodName:" + method.getName());
                    System.out.println("actionName:" + parentActionName+"/"+actionName);
                }
